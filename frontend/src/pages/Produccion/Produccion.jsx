...
const pipeFecha = (fecha) => {
  if (fecha) return fecha.split("-").reverse().join("/");
};

const pipeRegistroValue = (col, registro, index, offset) => {
...
const Produccion = () => {
  ...
  const [produccionToDelete, setProduccionToDelete] = useState(null);
  const [productionToDeleteNoItem, setProductionToDeleteNoItem] =
    useState(null);
  ...
  const fetchAndSetProduccion = async (body, newOffset = 0) => {
    try {
            ...
            <div className="form-group modal-dar-de-baja">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setMotivoSeleccionado(seleccionado);
                }}
              >
