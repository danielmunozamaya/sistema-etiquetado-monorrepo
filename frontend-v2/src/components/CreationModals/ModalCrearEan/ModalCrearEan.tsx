...
interface EanForm {
  ...
  diasBestBefore: string;
}

const ModalCrearEan: React.FC = () => {
  const [productos, setProductos] = useState<Producto[]>([]);
  const [presentaciones, setPresentaciones] = useState<Presentacion[]>([]);
  const modalCrearEanBtnRef = useRef<HTMLButtonElement>(null);
  const [ean, setEan] = useState<EanForm>({
    codigo: "",
    idProducto: "",
    idPresentacion: "",
    diasBestBefore: "",
  ...
  const handleChange = (campo: keyof EanForm, valor: string) => {
