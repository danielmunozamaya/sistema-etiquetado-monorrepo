...
const ModalCrearPresentacion: React.FC = () => {
  const modalCrearPresentacionBtnRef = useRef<HTMLButtonElement>(null);
  ...
  const handleChange = (campo: keyof PresentacionForm, valor: string) => {
